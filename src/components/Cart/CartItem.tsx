...
const CartItem: FC<CartPropsType> = ({ id, src, name, type, size, count, price, totalItemPrice }) => {
        ...
        <div className="cartItem">
            ...
            <div className="cartItem__block">
                <div className="cartItem__button">
                    <button disabled={count <= 1} className="cartItem__button-btn" onClick={() => dispatch(removeItemInCart({ id, src, name, type, size, price } as CartPropsType))}>
                    ...
                    <button className="cartItem__button-btn" onClick={() => dispatch(addItemToCart({ id, src, name, type, size, price } as CartPropsType))}>
                ...
                <button className="cartItem__button-remove grid__item" onClick={clearItemHandler}>
